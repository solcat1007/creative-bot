...
> 音频驱动色彩生成器 | 频谱到色彩映射 | 实时绘画 | Web Audio + Canvas

## Overview

色彩律动 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
