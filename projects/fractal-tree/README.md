...
> 交互式L-系统分形树 | 参数可调 | 风吹动画 | 纯Canvas零依赖

## Overview

分形之树 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
