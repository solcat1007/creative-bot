# 波之干涉 | wave-interference

> 双源波纹干涉模拟 | 实时渲染 | 参数可调 | 纯Canvas零依赖

## Overview

波之干涉 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
