# 词云生成器 | word-cloud-gen

> 实时词云生成工具 | 中文分词 | 多种形状蒙版 | 一键导出

## Overview

词云生成器 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
