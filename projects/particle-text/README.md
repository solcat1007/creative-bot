...
> 文字粒子化动画引擎 | 吸引/排斥/爆炸 | 鼠标交互 | 纯Canvas零依赖

## Overview

粒子文字 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
