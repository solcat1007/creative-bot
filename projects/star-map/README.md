...
> 实时星座绘制工具 | 鼠标连线命名 | 导出星图 | 纯Canvas零依赖

## Overview

星图 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
