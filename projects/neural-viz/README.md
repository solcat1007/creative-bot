...
> 小型神经网络可视化训练 | 实时前向传播 | 纯Canvas零依赖

## Overview

神经网络可视化 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
