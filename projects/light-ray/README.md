...
> 2D光线追踪可视化 | 反射折射模拟 | 材质编辑 | 纯Canvas零依赖

## Overview

光迹 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
