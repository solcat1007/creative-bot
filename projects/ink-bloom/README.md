...
> 水墨扩散生成艺术 | 点击生成墨花 | 物理模拟扩散 | 纯Canvas零依赖

## Overview

墨绽 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
