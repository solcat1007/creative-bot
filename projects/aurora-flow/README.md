...
> 极光粒子流场可视化 | Perlin噪声驱动 | 鼠标交互扰动 | 纯Canvas零依赖

## Overview

极光流 is an interactive web application built with pure HTML5 Canvas. Zero dependencies, zero build tools - just open `index.html` in any modern browser and start creating.
